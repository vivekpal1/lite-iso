...
# Add Bluetooth, cups, haveged, NetworkManager, & lightdm systemd links,
addnmlinks () {
...
ln -sf /usr/lib/systemd/system/lightdm.service ./mkshastra/airootfs/etc/systemd/system/display-manager.service
